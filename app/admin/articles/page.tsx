    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[720px] rounded-2xl shadow-2xl animate-modal-in bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 py-5 space-y-5 overflow-y-auto flex-1">
            ...
            <div className="space-y-4 md:col-span-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full h-10 px-3 rounded-lg text-sm border focus:outline-none focus:ring-2 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 ${
                    errors.title ? "border-red-400 focus:ring-red-100" : "border-neutral-200 dark:border-neutral-700 focus:border-[#0022FF] focus:ring-blue-100"
                  }`}
                />
          ...
          <div>
            ...
            <textarea
              ...
              rows={12}
              className={`w-full px-3 py-3 rounded-lg text-sm resize-none bg-neutral-50 dark:bg-neutral-800 border text-neutral-900 dark:text-neutral-100 leading-relaxed focus:outline-none focus:ring-2 ${
                errors.content ? "border-red-400 focus:ring-red-100" : "border-neutral-200 dark:border-neutral-700 focus:border-[#0022FF] focus:ring-blue-100"
              }`}
            />
        ...
        <div className="flex gap-2 px-6 py-4 border-t border-neutral-100 dark:border-neutral-800 flex-shrink-0 bg-neutral-50 dark:bg-neutral-900/30 rounded-b-2xl">
          ...
          <button onClick={handleSubmit} className="flex-1 h-10 rounded-xl text-sm font-semibold text-white bg-[#0022FF] hover:bg-[#0017AA] dark:bg-[#4d6bff] dark:hover:bg-[#3a56ee] transition-colors">
...
export default function AdminArticlesPage() {
  ...
  const handleSave = (data: Partial<Article>) => {
    if (modal?.type === "edit") {
      ...
      const newArticle: Article = {
        ...
        tags: [],
        author: { name: "Admin Crafties", role: "Super Admin" },
  ...
  return (
    <>
      <AdminHeader
        title="Articles"
        description="Manage educational guides, crafter feature articles, and Crafties craft trends."
      />
        ...
        <div className="rounded-2xl border bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 p-3 sm:p-4 border-b border-neutral-100 dark:border-neutral-800">
            ...
            <button
              ...
              className="ml-auto flex items-center gap-2 h-9 px-4 rounded-lg text-sm font-semibold text-white bg-[#0022FF] hover:bg-[#0017AA] dark:bg-[#4d6bff] dark:hover:bg-[#3a56ee] transition-colors"
            >
              <Plus size={15} />
              Write Article
            </button>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-neutral-100 dark:border-neutral-800">
                  {["Thumbnail", "Article Details", "Category", "Author", "Engagement", "Featured", "Actions"].map((h, i) => (
                    <th
                      key={h}
                      className={`px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-neutral-400 dark:text-neutral-500 whitespace-nowrap ${
                        i === 6 ? "text-right pr-6" : ""
                      }`}
                    >
                      {h}
                      ...
                      <td className="px-4 py-3.5 whitespace-nowrap">
                        <button
                          ...
                          className={`p-1.5 rounded-lg border transition-colors ${
                            art.isFeatured
                              ? "bg-amber-50 border-amber-200 text-amber-500 dark:bg-amber-950/40 dark:border-amber-900 dark:text-amber-400"
                              : "border-transparent text-neutral-300 hover:text-neutral-500 dark:hover:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"
                          }`}
                          title={art.isFeatured ? "Remove from featured" : "Set as featured"}
                        >
                          {art.isFeatured ? <Star size={15} fill="currentColor" /> : <StarOff size={15} />}
                        </button>
                      </td>
